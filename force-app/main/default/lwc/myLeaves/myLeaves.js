...
const COLUMNS = [
    ...
    {label : 'Manager Comment' , fieldName : 'Manager_Comment__c' , cellAttributes:{class: {fieldName : 
        'cellClass'}}},
...
export default class MyLeaves extends LightningElement 
{
    ...
    wiredmyLeaves(result) 
    {
        ...
        if(result.data)
        {
            this.myLeaves = result.data.map(a =>({
                ...a,
                cellClass: a.Status_c == 'Approved' ? 'slds-theme_success' : a.Status_c == 'Rejected' ? 
                'slds-theme_warning' : '',
    ...
    submitHandler(event)
    {
        ...
        if(new Date(fields.From_Date_c)>new Date(fields.To_Date_c))
        {
